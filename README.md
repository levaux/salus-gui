...
- [docs/plans/salus-gui-repo.md](docs/plans/salus-gui-repo.md) — the `v0.1.x` workspace-scaffold
...
- [docs/plans/harness-control-gui.md](docs/plans/harness-control-gui.md) — the `v0.2.x`
